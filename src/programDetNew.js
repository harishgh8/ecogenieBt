...
import { BucketCardRow, FixedTimeWindow } from "../shared";
...
import RenderInfoAccordion from "../shared/Render/RenderInfo/RenderInfoAccordion";
import "./../Common.css";
...
const ProgramDetails = (props) => {
  ...
  const [programThumbnailAndStatusCard, setProgramThumbnailAndStatusCard] =
    useState(true);
          ...
          {[...Array(numOfRows)].map((_, rowIndex) => (
            ...
            >
              {categories.map((category) => {
                ...
                return data ? (
                  <Grid item xs={2.4} className={globalStyles.addGridlines}>
          ...
          >
            ...
            >
              <Typography variant="h6">
                {getCodaI18nString("codats.alarm.log")}
              </Typography>
            </AccordionSummary>
        ...
        render: (wrapperKey) => (
          ...
          >
            ...
            >
              {" "}
              <Typography variant="h6">
                {getCodaI18nString("codats.event.log")}
              </Typography>
            </AccordionSummary>
            <AccordionDetails sx={{ height: "300px" }}>
              <IQDataGrid
        ...
        render: (wrapperKey) => (
          ...
          >
            ...
            >
              ...
              <Typography variant="h6">
                {" "}
                {getCodaI18nString("codats.video.alarm")}
              </Typography>
            </AccordionSummary>
        ...
        render: (wrapperKey) => (
          ...
          >
            ...
            >
              ...
              <Typography variant="h6">
                {" "}
                {getCodaI18nString("codats.audio.alarm")}
              </Typography>
            </AccordionSummary>
            <AccordionDetails>
              <AvailabilityChart
        ...
        render: (wrapperKey) => (
          ...
          >
            ...
            >
              ...
              <Typography variant="h6">
                {" "}
                {getCodaI18nString("codats.video.event")}
              </Typography>
            </AccordionSummary>
        ...
        render: (wrapperKey) => (
          ...
          >
            ...
            >
              ...
              <Typography variant="h6">
                {" "}
                {getCodaI18nString("codats.audio.event")}
              </Typography>
            </AccordionSummary>
        ...
        render: (wrapperKey) => (
          ...
          >
            ...
            >
              ...
              <Typography variant="h6">
                {" "}
                {getCodaI18nString("codats.video.availStatus")}
              </Typography>
            </AccordionSummary>
        ...
        render: (wrapperKey) => (
          ...
          >
            ...
            >
              ...
              <Typography variant="h6">
                {" "}
                {getCodaI18nString("codats.audio.availStatus")}
              </Typography>
            </AccordionSummary>
    ...
    return (
      ...
      >
        ...
        >
          ...
          <Typography variant="h6">
            {" "}
            {getCodaI18nString("codats.program.info")}
          </Typography>
        </AccordionSummary>
        ...
        <AccordionDetails>
          <Grid container>
            <Grid item xs={6}>
              <BucketCardRow
                title={getCodaI18nString("codats.program.label")}
          ...
          <Grid container>
            <Grid item xs={6}>
              <BucketCardRow
                title={getCodaI18nString("codats.program.channel")}
        ...
        <Grid container>
          ...
          <Grid item sx={{ mt: "12px" }}>
            <Stack direction="row" spacing={1}>
              ...
              <Chip sx={{ borderRadius: "20px" }} label="Clear" />
            </Stack>
          </Grid>
        </Grid>
      </>
  ...
  const renderProgramThumbnails = (wrapperKey = null) => {
    ...
    if (metrics) {
      _output.push(
        <img
          src={getVideoStreamThumbnail(flow.id, metrics.tsMetric.tsPgmMetric)}
          alt=""
  ...
  return (
    <MainContainer>
      ...
      <AppBarContainer position="fixed">
        <Toolbar>
          <PageHeaderWithCrumbs
            ...
            name={metrics?.tsMetric?.tsPgmMetric?.svcName}
            children={[
              {
      ...
      <DrawerContainer variant="permanent" open={open}>
        ...
        >
          <Typography sx={{ marginRight: "32px" }}>Program Details</Typography>
        ...
        <List>
          {[
            {
              text: MEDIA_VIEW.SUMMARY,
              icon: AssignmentOutlinedIcon,
              textLabel: "Summary",
            },
            {
              text: MEDIA_VIEW.DETAILS,
              icon: ListAltOutlinedIcon,
              textLabel: "Details",
            },
            {
              text: MEDIA_VIEW.AVAILABILITY,
            ...
            },
            {
              ...
              textLabel: "Key Metrics",
            },
          ].map(({ text, icon: Icon, textLabel }) => (
            <ListItem
              key={text}
              disablePadding
              sx={{
              ...
              >
                ...
                >
                  {open ? (
                    ...
                    <Tooltip title={textLabel} arrow placement="right">
                      <Icon
                        sx={{
                          color:
                            selectedMediaView === text ? "#fff" : "inherit",
                        }}
                      />
                    </Tooltip>
                  )}
        ...
        {metrics && pgmVideo && pgmAudio ? (
          <>
            ...
            >
              ...
              >
                <Typography variant="h6">Program history status</Typography>
              </AccordionSummary>
              <AccordionDetails
                sx={{
                  padding: "0px 0px 16px 0px",
                  // maxHeight: "500px", // Customize the collapse size here
                  overflowY: "auto",
                }}
              >
                <Grid
                      ...
                      >
                        <Grid container sx={{ p: 2 }}>
                          <Grid item xs={6}>
                            ...
                            >
                              {filters.rt
                                ? getCodaI18nString("codats.overall.program1")
                                : getCodaI18nString("codats.overall.program2")}
                          ...
                          <Grid item xs={6}>
                            ...
                            >
                              {filters.rt
                                ? getCodaI18nString("codats.overall.flow1")
                                : getCodaI18nString("codats.overall.flow2")}
                              :{" "}
                              <Link
                        ...
                        >
                          {filters.rt
                            ? getCodaI18nString("codats.alarm.status1")
                            : getCodaI18nString("codats.alarm.status2")}
                        </Typography>
                ...
                <Accordion key="HISTORY-WINDOW">
                  <AccordionSummary>
                    <Typography variant="h6">
                      {getCodaI18nString("codats.video.history")}
                    </Typography>
                  </AccordionSummary>
                  <AccordionDetails sx={{ backgroundColor: "#1e1e1e" }}>
                      ...
                      {/* <Grid item xs={6} className="historyPanelEndTime">
                        {alarmHistory !== "" && (
                          ...
                          >
                            {currentDateTimeFormattedSecs(
                              getUserTimeZoneTime(
                                alarmHistory[alarmHistory.length - 1]?.ts *
                                  1000,
                                timezoneOffset
                              )
                            )}
                    ...
                    <HistoryChicklets
                      title={getCodaI18nString("codats.availability.history")}
                ...
                <Accordion key="VIDEO-THUMBNAILS">
                  <AccordionSummary>
